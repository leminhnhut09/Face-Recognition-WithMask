...
#Có thể thấy rằng có hai bộ dữ liệu, emore và retina và chúng ta chỉ có thể chỉ định một bộ trong quá trình đào tạo.
#num_classes xuất phát từ thuộc tính, là số lượng id khuôn mặt, để phù hợp với dữ liệu tốt hơn
...
dataset.emore.dataset_path = '../datasets/test'
dataset.emore.num_classes = 3
...
#Hàm mất là trọng tâm của chúng tôi. Sau khi đọc nó, đừng nghĩ rằng nó quá phức tạp.
#loss_m1, loss_m2, loss_m3, xuất hiện 3 m, tác giả là để giảm số lượng mã, nhiều hàm mất được hợp nhất với nhau
#Tức là softmax，arcface，cosface，combined
...
default.pretrained = '../models/arcface_r100_v1/model'
