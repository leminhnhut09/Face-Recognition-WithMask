...
def parse_args():
  ...
  # general
  parser.add_argument('--data-dir', default='../datasets/face_recognition/', help='training set directory')
  parser.add_argument('--prefix', default='./models/model', help='directory to save model.')
  parser.add_argument('--pretrained', default='../models/model-y1-test2/model,0', help='pretrained model to load')
  parser.add_argument('--ckpt', type=int, default=0, help='checkpoint saving option. 0: discard saving. 1: save when necessary. 2: always save')
